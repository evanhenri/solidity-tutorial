...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    // NOTE: this could cause a problem if metamask has a network selected where
    // the escrow contract has not been deployed.
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-sm-12">
             <p>Balance: <b>{this.state.balance}</b> wei </p>
          </div>
        </div>
