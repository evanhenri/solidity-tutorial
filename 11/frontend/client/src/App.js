...
function App() {
  ...
  // useEffect is the equivalent of componentDidMount when using class based views
  useEffect(() => {
    // wrap things in an async function because react will complain if we try to
